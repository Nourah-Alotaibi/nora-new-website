export const laptopProjects = [
  ...
  { title: "DecafShot", description: "An AI-assisted cybersecurity tool built to support CTF problem-solving, testing, and continuous improvement.", image: null as string | null, github: "https://github.com/Nourah-Alotaibi/DecafShot-No-AI-CTF-tool" as string | null },
